...
| `placement`          | `placement`           | Popper placement, e.g. "bottom-start".                                                      | `Placement`                     | `'bottom-start'`                            |
| `strategy`           | `strategy`            | Positioning strategy ("absolute" or "fixed").                                               | `Strategy`                      | `'absolute'`                                |
